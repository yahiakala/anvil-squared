...
# tag = _html_injector._create_tag("link", href='_/theme/theme_md3.css', rel="stylesheet", tyle='text/css')
# _html_injector._inject(tag)
# _html_injector._wait_for_load(tag)
