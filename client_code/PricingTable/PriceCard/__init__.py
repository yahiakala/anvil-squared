...
class PriceCard(PriceCardTemplate):
    def __init__(self, **properties):
        ...
        if "align" in self.item and self.item["align"] is False:
        ...
        if self.item["suptitle_text"]:
            ...
            self.optional_attr(
                self.lbl_suptitle, "background", "suptitle_background_color"
            )
            self.optional_attr(self.lbl_suptitle, "foreground", "suptitle_color")
            if self.item["suptitle_border_color"]:
                self.item["suptitle_border"] = (
                    "1px solid " + self.item["suptitle_border_color"]
                )
    ...
    def form_show(self, **event_args):
        ...
        self.optional_attr(
            lbl_suptitle_dom.style, "borderRadius", "suptitle_border_radius"
        )
